...
rvat_cli_methods_flags <- unlist(lapply(rvat_cli_methods, FUN = function(x) {
...
rvat_cli_flags <- unlist(lapply(rvat_cli_options, FUN = function(x) {
  if (x@action == "store_true" && !is.na(x@long_flag)) {
    x@long_flag
  } else if (x@action == "store_true" && !is.na(x@short_flag)) {
    x@short_flag
